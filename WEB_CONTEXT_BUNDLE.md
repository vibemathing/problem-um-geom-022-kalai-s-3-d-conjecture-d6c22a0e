...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-geom-022-kalai-s-3-d-conjecture-d6c22a0e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geom-022-ed8a01418918",
        "url": "https://www.unsolvedmath.com/problems/GEOM-022"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does every centrally symmetric $d$-dimensional polytope have at least $3^d$ faces?",
      "version": 1
    },
    "title": "Kalai's 3^d Conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "45ec2b98c949ccb970aafffa8b8fbb5f0248f08ba4574e9cf02f64004193ff90"
}
```
